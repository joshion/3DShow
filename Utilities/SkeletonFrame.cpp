    ...
    m_pPointsData(nullptr)
{
    ...
    unsigned short *pOrigElement = this->m_pElement;
    ...
    {
        this->m_pElement = new unsigned short[other.m_ElementLength];
...
SkeletonFrame SkeletonFrame::fromBytes(const unsigned char * pData, unsigned int uLength)
{
    ...
    result.m_pElement = new unsigned short[result.m_ElementLength];
