...
private:
    ...
    * 此处要求程序保证每个窗口名字不同
    */
    QMap<QString, QMdiSubWindow*> *m_p_Title_Widget;
...
/*GUI内部的通信*/
public slots:
    void slot_createSubWidget(QString strWindowTitle, Utilities::ShowType type);
    void slot_showSubWidget(QString strWindowTitle);
    ...
    */
    ...
    void slot_closeSubWidget(QString strWindowTitle);
