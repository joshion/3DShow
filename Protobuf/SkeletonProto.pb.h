...
class pbRespEnd : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SkeletonProto.pbRespEnd) */ {
 public:
  pbRespEnd();
  virtual ~pbRespEnd();
  ...
  // @@protoc_insertion_point(class_scope:SkeletonProto.pbRespEnd)
 private:
